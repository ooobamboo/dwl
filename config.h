...
static const Modekey modekeys[] = {
	...
	{ wlrctl, { WLR_MODIFIER_CTRL,  XKB_KEY_h,          spawn,      	SHCMD("wlrctl keyboard key Left") } },
	{ wlrctl, { WLR_MODIFIER_CTRL,  XKB_KEY_j,          spawn,      	SHCMD("wlrctl keyboard key Down") } },
	{ wlrctl, { WLR_MODIFIER_CTRL,  XKB_KEY_k,          spawn,      	SHCMD("wlrctl keyboard key Up") } },
	{ wlrctl, { WLR_MODIFIER_CTRL,  XKB_KEY_l,          spawn,      	SHCMD("wlrctl keyboard key Right") } },
